export const blogs = [
  {
    ...
    description:
      "Learn how debouncing improves web performance by limiting the rate at which a function is executed.",
    content: [
      {
        type: "text",
        header: "What is Debouncing?",
...
function debounce(fn, delay) {
  ...
  },
  {
    ...
    description:
      "Master the useEffect hook to manage side effects like data fetching in your React applications.",
    content: [
      {
        type: "text",
        header: "Introduction to useEffect",
