...
const BottomBar = () => {
  ...
  return (
    <nav className='fixed bottom-0 bg-black h-[64px] lg:h-[72px] w-full grid grid-cols-12 ff-aalto uppercase text-3xl xl:text-4xl tracking-wider max-w-[1799px] grid-border !border-y-0 !border-l-0 '>
        <div className='hidden sm:grid place-content-center sm:col-span-5 lg:col-span-3 opacity-90  grid-border !border-x-0 !border-b-0 px-2'>
          <Timer />
        </div> 
