    ...
    <section className='section-container grid grid-cols-12'>
      <article className='col-span-5'>
        ...
        <article className='p-6'>
          <h1 className='text-4xl xs:text-5xl tacking-[1px] ff-aalto relative pl-4'><ChevronIcon className='absolute h-6 w-6 top-1/2 -translate-y-1/2 -left-3' /> Who we are</h1>
